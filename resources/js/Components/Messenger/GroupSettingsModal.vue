<!-- resources/js/Components/Messenger/GroupSettingsModal.vue -->
<template>
    <dialog ref="dialogRef" class="modal">
        <div class="modal-box max-w-md p-6 space-y-4">
            ...
            <div class="flex items-center gap-4">
                <img
                    :src="props.conversation.avatar_url || '/default-group.png'"
                    class="w-16 h-16 object-cover rounded-lg border"
                    alt="Group Avatar"
                />
                <div v-if="isAdmin">
                    <label class="btn btn-sm btn-outline flex items-center gap-1">
