...
<template>
    <Teleport to="body">
        <dialog ref="modalRef" class="modal">
            <div class="modal-box w-full max-w-3xl max-h-[90vh] sm:max-h-[80vh] p-0 overflow-hidden">
                <!-- HEADER -->
              ...
              : 'hover:bg-base-200'"
                ...
                <!-- RESULTS -->
                <div class="p-4 sm:p-6 overflow-y-auto max-h-[calc(90vh-9rem)] space-y-8">
                    <!-- Артворки -->
                        ...
                        <div class="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 gap-3">
                            <template v-if="rows.authors.length">
                                <Link
                                    ...
                                    :key="u.id"
                                    :href="`/profile/${u.id}`"
                                    class="flex items-center gap-3 p-2 rounded-lg hover:bg-base-300"
                                >
                                    <img
                                        :src="u.avatar"
